...
@Component({
  ...
  imports: [IonItemOption, IonItemOptions, IonLabel, IonItemSliding, IonItem, IonList, IonCardContent, IonCardSubtitle, IonCardTitle, IonCardHeader, IonCard, IonText, IonButtons, IonMenuButton, IonContent, IonHeader, IonTitle, IonToolbar, IonThumbnail, IonGrid, IonRow, IonCol, IonButton, IonIcon, CommonModule, FormsModule],
  providers: [Storage]
})
export class VeiculoPage implements OnInit {
  ...
  mostrarNaoImplementado() {
    this.apresenta_mensagem('Funcionalidade não implementada ainda.');
  }
}